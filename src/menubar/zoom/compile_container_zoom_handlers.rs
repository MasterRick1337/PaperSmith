...
pub fn zoom_increase_handler(
    ...
    Callback::from(move |_| {
        ...
        font_size_compile.set(current_font_size + 1.0);
...
pub struct ZoomProps {
    pub font_size_compile: UseStateHandle<f64>,
}

// Component to render the zoome controls
#[function_component(ZoomControlsCompile)]
pub fn zoom_controls(ZoomProps { font_size_compile }: &ZoomProps) -> Html {
    ...
    html! {
        <div class="subbar-compile-icon">
            // Button to decrease zoom
            <Icon
                class="zoom-out-button-compile"
